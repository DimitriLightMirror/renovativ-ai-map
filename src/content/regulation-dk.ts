...
export const REGULATION_DK: RegulationItem[] = [
  {
    key: 'energimaerkning',
    title: 'Energimaerkningsordningen (mandatory energy labelling scheme)',
    shortName: 'Energimaerket',
    summary:
      'The Energimaerkningsordningen is the Danish implementation of the European Energy Performance of Buildings Directive. An energimaerke is mandatory when a building is sold, rented out or newly built. Labels run from A2020, A2015 and A2010 (best, tied to the building code vintage) down through B, C, D, E, F to G (worst). Certificates are issued by an accredited energy consultant (energikonsulent) and registered in the national EMO database administered by Energistyrelsen (the Danish Energy Agency).',
    obligations: [
      'A valid energimaerke is mandatory at sale, at rental and for new buildings.',
  ...
  },
  {
    ...
    summary:
      'Every registered energimaerke lives in EMO (Energimaerkning Online), the national label register operated by Energistyrelsen. Each certificate holds the address, BBR building reference, label classification, heated floor area and a tiltaksplan: a list of concrete renovation proposals with estimated investment cost and annual saving in DKK. The register is publicly searchable by address on tjekenergimaerke.emoweb.dk, and its EMOData API is the data source behind the Danish buildings shown in this app.',
    obligations: [
      'All energimaerke certificates are registered centrally in EMO.',
  ...
  },
  {
    ...
    thresholds: [
      ...
      { label: 'Priority stock', value: 'energimaerke E, F and G' },
    ],
  ...
  },
  {
    ...
    summary:
      'Energirenoveringspuljen is the current national subsidy pool for energy renovation of year-round homes, replacing the closed Bygningspuljen. It subsidises insulation, window replacement, ventilation systems and hydronic (water-borne) space heating, plus the energimaerke itself. Eligibility requires a valid energimaerke D, E, F or G (label D added from February 2025). Works must be carried out by a company with a CVR number and must not start before the grant is approved. The pool opens in rounds and funds are allocated first come, first served.',
    obligations: [
      'Home must be a year-round dwelling (helaarsbolig) owned by the applicant.',
      'Valid energimaerke D, E, F or G is required for envelope measures.',
      'Works may not start before the grant approval (forhaandsgodkendelse).',
      'Work must be invoiced by a company with a valid CVR number, no DIY.',
    ],
    thresholds: [
      { label: 'Measures', value: 'insulation, windows, ventilation, hydronic heating, energimaerke' },
      { label: 'Eligibility', value: 'energimaerke D, E, F or G (D since 2025)' },
  ...
  },
  {
    ...
    summary:
      'Varmepumpepuljen pays a fixed grant to owners of year-round homes who replace an oil boiler, gas boiler, electric heating or pellet stove with an air-to-water or ground-source heat pump. No energimaerke is required to apply, and the grant must be approved before signing with the installer. Reference amounts: 17,000 kr per conversion in the 2025 rounds, raised to 27,000 kr in the 2026 round. Homes inside district heating areas are directed to fjernvarme conversion instead, so the pool targets the off-network stock.',
    obligations: [
      'Applicant must own a year-round home (helaarsbolig).',
