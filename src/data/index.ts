/**
 * Renovativ AI Map — typed loader for the deterministic French sample dataset.
 *
 * The dataset is generated by scripts/generate-buildings.mjs (seeded, reproducible)
